...
function ProviderIcon({ provider }: { provider: string }) {
  ...
  if (provider === 'google')
    return (
      <svg viewBox="0 0 24 24">
        <path d="M21.2 12.2c0-.7-.1-1.4-.2-2H12v3.8h5.1a4.4 4.4 0 0 1-1.9 2.9v2.5h3.1c1.8-1.7 2.9-4.2 2.9-7.2Z" />
        <path d="M12 21.5c2.6 0 4.8-.9 6.4-2.3l-3.1-2.5c-.9.6-2 .9-3.3.9-2.5 0-4.6-1.7-5.4-4H3.4V16a9.5 9.5 0 0 0 8.6 5.5Z" />
        <path d="M6.6 13.6a5.7 5.7 0 0 1 0-3.5V7.7H3.4a9.5 9.5 0 0 0 0 8.4l3.2-2.5Z" />
        <path d="M12 6.1c1.4 0 2.7.5 3.7 1.4l2.8-2.8A9.4 9.4 0 0 0 3.4 7.7l3.2 2.5c.8-2.4 2.9-4.1 5.4-4.1Z" />
      </svg>
    );
  if (provider === 'yandex')
    return (
      <svg viewBox="0 0 24 24">
        <path d="M13.2 20H9.7l2.1-5.1C8.5 14.2 7 12.2 7 9.5 7 5.9 9.6 4 13.1 4H17v16h-3.3V7.2h-.8c-1.6 0-2.6.8-2.6 2.3 0 1.7 1.1 2.6 3.2 2.6v2.7L13.2 20Z" />
      </svg>
    );
  if (provider === 'vk')
    return (
