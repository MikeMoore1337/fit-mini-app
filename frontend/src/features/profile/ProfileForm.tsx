      ...
      >
        <section className="profile-form-section" aria-labelledby="profile-personal-title">
          <div className="profile-form-section__head">
            ...
            <p>Имя, дата рождения и часовой пояс используются только в вашем рабочем контексте.</p>
          </div>
          ...
          <div className="form-grid profile-form-grid profile-form-grid--fitness">
            ...
            <label className="field">
              ...
              <input
                ...
                aria-describedby={
                  validationErrors.workouts_per_week ? 'profile-workouts_per_week-error' : undefined
                }
                onChange={(event) =>
