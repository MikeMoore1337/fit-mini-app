...
const features = [
  ...
  },
  {
    ...
    text: 'Включите режим тренера сразу, приглашайте клиентов, назначайте и корректируйте программы, отслеживайте тренировки, прогресс и показатели каждого человека.',
    variant: 'coach',
    path: '/for-trainers',
  },
];
      ...
      <main id="landing-content" tabIndex={-1}>
        ...
        <section className="landing-audience" aria-label="Выберите подходящий сценарий">
          ...
          <article>
            ...
            <h2>Включите режим тренера и откройте кабинет</h2>
            <p>
              Войдите в приложение как обычный пользователь и включите режим тренера в профиле.
              Кабинет откроется сразу: сможете приглашать клиентов, назначать программы и следить за
              прогрессом.
            </p>
        ...
        <section id="contact" className="landing-contact">
          <div className="landing-contact__copy">
            ...
            <p>
              Создайте обычный аккаунт и начните тренироваться. Если хотите вести клиентов, включите
              режим тренера в разделе «Профиль» — заявка и ожидание одобрения не нужны.
            </p>
          </div>
