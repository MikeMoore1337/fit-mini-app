...
test('favicon is canonical SVG and remains distinct at 16 and 32 pixels', async ({ page }) => {
  ...
  await page.setContent(`
    ...
    <img src="/assets/brand/yfc-logo-light.svg" width="400" height="72" alt="Your Fitness Coach" />
    <div class="dark"><img src="/assets/brand/yfc-logo-dark.svg" width="400" height="72" alt="Your Fitness Coach" /></div>
  `);
  ...
  await page.setContent(`
    ...
    <img src="/assets/brand/favicon.svg" width="16" height="16" alt="" />
    <img src="/assets/brand/favicon.svg" width="32" height="32" alt="" />
  `);
