...
Owner-selected task `106` отдельно фиксирует discoverability Telegram Mini App, поддержки и
публичного канала на Landing. Она не меняет порядок `80-101` и требует отдельного owner запуска.
