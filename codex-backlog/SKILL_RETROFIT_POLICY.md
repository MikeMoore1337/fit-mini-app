...
- закрыть подтверждённые `BLOCKER/HIGH`;
- выполнить небольшой безопасный `MEDIUM`, если он остаётся в scope;
- вынести крупный `MEDIUM` владельцу и синхронизировать в `bugs/FINDINGS.md`;
