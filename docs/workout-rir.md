...
калории или оценку готовности. Детерминированная рекомендация прогрессии может использовать только
полное покрытие RIR как дополнительное evidence и остаётся работоспособной без него; правила и
ограничения описаны в [`progression-guidance.md`](progression-guidance.md). Автоматическая оценка,
преобразование RPE и recovery score не входят в продукт.
