...
| --- | --- | --- |
| Desktop rail | `164px`, V2 logo/icons/type, active secondary surface + lime inline marker; grouped primary/secondary/workspace/account destinations. | Long labels wrap to two lines only in secondary groups; permission-hidden destinations are not authorization boundary; loading user identity uses reserved geometry. |
