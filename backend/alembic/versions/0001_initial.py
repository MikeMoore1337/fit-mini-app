...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), primary_key=True),
        sa.Column(
            "program_id", sa.Integer(), sa.ForeignKey("program_templates.id"), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), primary_key=True),
        sa.Column(
            "day_id", sa.Integer(), sa.ForeignKey("program_template_days.id"), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column("user_id", sa.Integer(), sa.ForeignKey("users.id"), nullable=False),
        sa.Column(
            "template_id", sa.Integer(), sa.ForeignKey("program_templates.id"), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), primary_key=True),
        sa.Column(
            "user_program_id", sa.Integer(), sa.ForeignKey("user_programs.id"), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "workout_exercise_id",
            sa.Integer(),
            sa.ForeignKey("user_workout_exercises.id"),
            nullable=False,
        ),
