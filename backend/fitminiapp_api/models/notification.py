...
class NotificationSetting(Base):
    ...
    meal_reminders_enabled: Mapped[bool] = mapped_column(Boolean, default=False)
    hydration_reminders_enabled: Mapped[bool] = mapped_column(Boolean, default=False)
    movement_reminders_enabled: Mapped[bool] = mapped_column(Boolean, default=False)
