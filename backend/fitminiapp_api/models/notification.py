...
class NotificationSetting(Base):
    ...
    meal_reminders_enabled: Mapped[bool] = mapped_column(Boolean, default=False, nullable=True)
    hydration_reminders_enabled: Mapped[bool] = mapped_column(Boolean, default=False, nullable=True)
    movement_reminders_enabled: Mapped[bool] = mapped_column(Boolean, default=False, nullable=True)
